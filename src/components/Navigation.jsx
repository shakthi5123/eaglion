    ...
    <nav className="border-b border-gray-200 sticky top-0 z-50 shadow-md bg-white">
      <div className="flex items-center justify-between max-w-7xl mx-auto w-full px-6 py-2">
        ...
        <ul className="hidden md:flex space-x-8">
          <li className="hover:text-red-500" data-aos="fade-up" data-aos-delay="100">
            <a href="#home">Home</a>
          </li>
          <li className="hover:text-red-500" data-aos="fade-up" data-aos-delay="200">
            <a href="#products">Explore Products</a>
          </li>
          <li className="hover:text-red-500" data-aos="fade-up" data-aos-delay="300">
            <a href="#about">About</a>
          </li>
          <li className="hover:text-red-500" data-aos="fade-up" data-aos-delay="400">
      ...
      {isOpen && (
        <div className="md:hidden flex flex-col items-center px-5 pb-4 space-y-4">
          <a href="#home" className="block hover:text-red-500 border-b border-gray-800">Home</a>
          <a href="#products" className="block hover:text-red-500 border-b border-gray-800">Explore Products</a>
